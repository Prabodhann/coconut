...
export function LoginPopup({ setShowLogin }: LoginPopupProps) {
      ...
      >
        ...
        >
          ...
          <form onSubmit={onLogin} className="space-y-6 relative">
            ...
            >
              {currState === UI_CONTENT.LOGIN.LOGIN_TITLE
                ? UI_CONTENT.LOGIN.LOGIN_BTN
                : UI_CONTENT.LOGIN.CREATE_ACCOUNT_BTN}
            </Button>
            ...
            <div className="pt-4 text-center mt-2 border-t border-zinc-100 dark:border-zinc-800">
              {currState === UI_CONTENT.LOGIN.LOGIN_TITLE ? (
                ...
                <p className="text-zinc-600 dark:text-zinc-400">
                  ...
                  <button
                    type="button"
                    onClick={() => setCurrState(UI_CONTENT.LOGIN.LOGIN_TITLE)}
                    className="text-orange-500 font-semibold hover:underline"
                  >
