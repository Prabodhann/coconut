  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        <img
          className="w-[120px] lg:w-[150px] object-cover dark:brightness-[0.8] dark:contrast-[1.2]"
          src={assets.logo.src ?? assets.logo}
          alt="logo"
        />
        <span className="bg-orange-100 dark:bg-orange-500/20 text-orange-600 dark:text-orange-400 text-xs font-semibold px-2 py-0.5 rounded border border-orange-200 dark:border-orange-500/30">
          Admin Panel
        </span>
      </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="w-[40px] h-[40px] rounded-full overflow-hidden border-2 border-orange-500 dark:border-orange-400 cursor-pointer hover:shadow-md transition-shadow">
          <img
            ...
            src={assets.profile_image.src ?? assets.profile_image}
            alt="profile"
          />
        </div>
      </div>
