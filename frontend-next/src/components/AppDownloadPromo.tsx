        ...
        <div className="relative z-10 px-6 py-12 md:py-16 flex flex-col items-center text-center space-y-10">
          <div className="space-y-6 max-w-2xl">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-white leading-tight">
              {UI_CONTENT.APP_DOWNLOAD.TEXT.split(" Download ")[0]}
              <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600">
                Download
              </span>
              <br />
              {UI_CONTENT.APP_DOWNLOAD.TEXT.split(" Download ")[1]}
            </h2>
            <p className="text-zinc-400 md:text-lg">
              Get the full Coconut experience in the palm of your hand. Fast
              delivery, exclusive deals, and easy tracking.
            </p>
          </div>
              ...
              {status === "success" ? (
                ...
                >
                  ...
                  <p className="text-zinc-400 text-sm italic">
                    Check your inbox for a special message from Coconut.
                  </p>
                  <button
                ...
                >
                  ...
                  <p className="text-zinc-500 text-xs mt-3">
                    We only send delicious updates. No spam, ever.
                  </p>
                </motion.form>
              )}
            </AnimatePresence>
